...
namespace R
{
    public static class MimeType
    {
        ...
        {
            if (fileName.IsNullOrEmpty() || string.IsNullOrWhiteSpace(fileName))
                return null;
            ...
            return Mappings.TryGetValue(extension, out mime)
                ? mime
                : (GetWindowsMimeType(extension, out mime) ? mime : "application/octet-stream");
        }
